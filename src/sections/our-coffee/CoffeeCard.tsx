  ...
  return (
    ...
    >
      <Image
        ...
        className="object-cover opacity-0 scale-100 transition-[opacity,transform] duration-700 ease-out group-hover:scale-[1.06] group-hover:opacity-100 group-focus-visible:scale-[1.06] group-focus-visible:opacity-100"
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/35 to-black/75 opacity-0 transition-opacity duration-500 group-hover:opacity-100 group-focus-visible:opacity-100" />

      <div className="relative z-10 flex w-full flex-col gap-5 p-8 transition-opacity duration-300 group-hover:opacity-0 group-focus-visible:opacity-0 sm:p-10">
      ...
      <div className="pointer-events-none absolute inset-0 z-20 flex translate-y-3 flex-col p-8 text-white opacity-0 transition-[opacity,transform] delay-75 duration-500 group-hover:translate-y-0 group-hover:opacity-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 sm:p-10">
        <div className="flex flex-col gap-2">
